  ...
  return (
    ...
    >
      <HoverCard.Root openDelay={400} closeDelay={100}>
        ...
        <HoverCard.Portal>
          <HoverCard.Content 
            className="hidden md:block z-50 w-[320px] p-4 bg-[#141519] border border-white/10 rounded-xl shadow-2xl text-white data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2"
            side="right" 
            align="start"
            sideOffset={10}
