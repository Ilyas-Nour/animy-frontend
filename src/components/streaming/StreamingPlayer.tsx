...
export function StreamingPlayer({ episodeId, episodeNumber, poster, provider, malId, title, tmdbId }: StreamingPlayerProps) {
    ...
    }, [episodeId, episodeNumber, malId, title, tmdbId])
