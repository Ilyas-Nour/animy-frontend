...
export default function MessageInput({ onSendMessage, onTyping, replyingTo, onCancelReply }: MessageInputProps) {
    ...
    return (
        <div className="flex flex-col gap-3 relative">
            ...
            <div className="mx-4 mb-2 p-1.5 bg-background dark:bg-[#18181b] rounded-full border border-border/40 dark:border-white/10 flex items-center gap-2 shadow-2xl dark:shadow-black/50 relative z-20">
