          ...
          >
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full bg-white/8 backdrop-blur-sm border border-white/12 rounded-xl pl-11 pr-28 py-3 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-purple-500/50 focus:bg-white/10 transition-all duration-200"
              />
              {searchInput && (
                <button
                  type="button"
