...
function MoviesContent() {
  ...
  const totalResults = pagination?.items?.total ?? movies.length
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden border-b border-border mb-8">
        ...
        <div className="absolute top-4 right-24 w-32 h-32 rounded-full bg-emerald-600/10 blur-3xl animate-pulse" />
        <div className="absolute bottom-2 left-1/3 w-24 h-24 rounded-full bg-teal-600/10 blur-2xl animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className="relative container px-4 sm:px-6 py-10 sm:py-14">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-600 to-teal-700 flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.4)]">
          ...
          >
            <div className="relative flex items-center">
              ...
              <button
                type="submit"
                className="absolute right-2 px-4 py-1.5 rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-xs font-bold hover:from-emerald-500 hover:to-teal-500 transition-all duration-200 shadow-[0_0_12px_rgba(16,185,129,0.3)]"
              >
                Search
              </button>
            </div>
