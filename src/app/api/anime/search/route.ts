...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        if (q) queryParams.append('query', q) // Backend expects 'query', not 'q'
        ...
        const response = await fetch(`${API_URL}/anime/search?${queryParams.toString()}`, {
        ...
        console.warn('[anime/search] Backend unavailable, using static fallback:', error.message)
